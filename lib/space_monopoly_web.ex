defmodule SpaceMonopolyWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SpaceMonopolyWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/space_monopoly_web/templates",
        namespace: SpaceMonopolyWeb
  ...
  defp view_helpers do
    quote do
      ...
      import SpaceMonopolyWeb.ErrorHelpers
      import SpaceMonopolyWeb.Gettext
      alias SpaceMonopolyWeb.Router.Helpers, as: Routes
    end
  end
